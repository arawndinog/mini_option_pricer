...
testing.assert_approx_equal(asian_option_model.arithmeticStandardMC(), 7.753, 4)
testing.assert_approx_equal(asian_option_model.arithmeticStandardMCWithCV(), 7.80, 4)
print("  PASS")
